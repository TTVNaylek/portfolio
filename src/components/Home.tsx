    ...
    <>
      ...
      <main>
        ...
        <p>
          ...
          Like an original weeb i love watch animes and playing video games, especially Valorant despite of my bronze rank.
        </p>
        <h2>Why this website?</h2>
        <p>
          You can see 3 buttons, the first is the Home <i className="fa-solid fa-house"></i>, the second is the projects <i className="fa-solid fa-hammer"></i> page where you can see my projects.
          And the third is ??? Don't worry about it there's nothing there.
          This website will permit me to show you my skills with my projects like what languages I use to realize them.
